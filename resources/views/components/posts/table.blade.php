            ...
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <button type="button" id="createProductModalButton" data-modal-target="createProductModal"
                        ...
                        class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 bg-blue-600">
                ...
                <table class="w-full text-sm text-left text-gray-500 ">
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr class="border-b">
                                <th scope="row" class="px-4 py-5 font-medium text-gray-900 whitespace-nowrap">{{ $loop->iteration }}</th>
                                <td class="px-4 py-3">{{ $post->blog_title }}</td>
                                <td class="px-4 py-3">{{ $post->category->name_category }}</td>
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            ...
            <div class="flex justify-center items-center space-x-4">
                <button data-modal-toggle="deleteModal" type="button"
                    class="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-1">No,
                    cancel</button>
                <button type="submit"
