        ...
        <div class="bg-white relative border sm:rounded-lg overflow-hidden">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 ">
                    ...
                    <tbody>
                        <tr class="border-b">
                            <th scope="row" class="px-4 py-5 font-medium text-gray-900 whitespace-nowrap">1</th>
                            <td class="px-4 py-3">Judul</td>
                            <td class="px-4 py-3">Nanami</td>
                            <td class="px-4 py-3">Apple</td>
                            <td class="px-4 py-3">10-20-20</td>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2"><label for="description"
                        ...
                        <textarea id="description" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 "
